...
export type SealedProduct = {
  ...
  targetTcin?: number;       // pinned Target TCIN — enables direct-page stock monitoring
  walmartItemId?: number;    // pinned Walmart usItemId — enables direct-page stock monitoring
  hotness: Hotness;
  notes: string;
};
...
export const PRODUCTS: SealedProduct[] = [
  ...
  { id: "stellar-etb", targetTcin: 91619912, imageUrl: tcgProductImg(557350), tcgProductId: 557350, name: "Stellar Crown Elite Trainer Box", set: "Stellar Crown", type: "ETB", msrp: 49.99, tcgplayerUrl: tcgUrl("Stellar Crown Elite Trainer Box"), ...retailLinks("Stellar Crown Elite Trainer Box"), ebayQuery: "Stellar Crown Elite Trainer Box", hotness: "✅ Stable", notes: "Steady $55–65 range" },
  ...
  { id: "paldean-bundle", targetTcin: 89432660, imageUrl: tcgProductImg(528771), tcgProductId: 528771, name: "Paldean Fates Booster Bundle", set: "Paldean Fates", type: "Booster Bundle", msrp: 26.94, tcgplayerUrl: tcgUrl("Paldean Fates Booster Bundle"), ...retailLinks("Paldean Fates Booster Bundle"), ebayQuery: "Paldean Fates Booster Bundle", hotness: "🔥 Hot", notes: "~$163, 6× retail — shiny-set bundles never cooled" },

  // --- 30th Celebration Wave 1 (releases Sep 16, 2026) — dual Target + Walmart
  // direct-page monitoring. Every TCIN/usItemId below was verified live
  // (Sep 15, 2026): fetched the actual product page from this app's network
  // class and confirmed the name on the page matches, before pinning. Not
  // yet found: 2-Pack Blister (no confirmed Target/Walmart product id) and
  // Pokemon Center ETB (Pokemon Center exclusive — not sold at Target/Walmart).
  { id: "30th-etb", targetTcin: 1010892076, walmartItemId: 20640569221, imageUrl: "https://images.pokemontcg.io/sv3pt5/logo.png", name: "30th Celebration Elite Trainer Box", set: "30th Celebration", type: "ETB", msrp: 49.99, tcgplayerUrl: tcgUrl("30th Celebration Elite Trainer Box"), ...retailLinks("Pokemon 30th Celebration Elite Trainer Box"), ebayQuery: "Pokemon 30th Celebration Elite Trainer Box", hotness: "🔥 Hot", notes: "First-ever worldwide simultaneous TCG release — Sep 16, 2026 launch wave" },
  { id: "30th-sylveon-ex-box", targetTcin: 1010892068, walmartItemId: 20724308586, imageUrl: "https://images.pokemontcg.io/sv3pt5/logo.png", name: "30th Celebration Sylveon ex Box", set: "30th Celebration", type: "ETB", msrp: 21.99, tcgplayerUrl: tcgUrl("30th Celebration Sylveon ex Box"), ...retailLinks("Pokemon 30th Celebration Sylveon ex Box"), ebayQuery: "Pokemon 30th Celebration Sylveon ex Box", hotness: "🔥 Hot", notes: "Sep 16 launch wave — Sylveon ex foil + oversize promo" },
  { id: "30th-greninja-ex-box", targetTcin: 1010892065, walmartItemId: 20675366009, imageUrl: "https://images.pokemontcg.io/sv3pt5/logo.png", name: "30th Celebration Greninja ex Box", set: "30th Celebration", type: "ETB", msrp: 21.99, tcgplayerUrl: tcgUrl("30th Celebration Greninja ex Box"), ...retailLinks("Pokemon 30th Celebration Greninja ex Box"), ebayQuery: "Pokemon 30th Celebration Greninja ex Box", hotness: "🔥 Hot", notes: "Sep 16 launch wave — Greninja ex foil + oversize promo" },
  { id: "30th-knockout", targetTcin: 1010892070, walmartItemId: 20638470037, imageUrl: "https://images.pokemontcg.io/sv3pt5/logo.png", name: "30th Celebration Knock Out Collection", set: "30th Celebration", type: "Premium Collection", msrp: 9.99, tcgplayerUrl: tcgUrl("30th Celebration Knock Out Collection"), ...retailLinks("Pokemon 30th Celebration Knock Out Collection"), ebayQuery: "Pokemon 30th Celebration Knock Out Collection", hotness: "📈 Rising", notes: "Sep 16 launch wave — Eevee foil + coin, low-entry pickup" },
  { id: "30th-poster", targetTcin: 1010892067, walmartItemId: 20671207153, imageUrl: "https://images.pokemontcg.io/sv3pt5/logo.png", name: "30th Celebration Poster Collection", set: "30th Celebration", type: "Premium Collection", msrp: 14.99, tcgplayerUrl: tcgUrl("30th Celebration Poster Collection"), ...retailLinks("Pokemon 30th Celebration Poster Collection"), ebayQuery: "Pokemon 30th Celebration Poster Collection", hotness: "📈 Rising", notes: "Sep 16 launch wave — Articuno/Zapdos/Moltres promos + poster" },
  { id: "30th-tech-sticker-lucario", targetTcin: 1010892078, walmartItemId: 20703722701, imageUrl: "https://images.pokemontcg.io/sv3pt5/logo.png", name: "30th Celebration Tech Sticker Collection (Lucario)", set: "30th Celebration", type: "Premium Collection", msrp: 14.99, tcgplayerUrl: tcgUrl("30th Celebration Tech Sticker Collection"), ...retailLinks("Pokemon 30th Celebration Tech Sticker Collection Lucario"), ebayQuery: "Pokemon 30th Celebration Tech Sticker Collection Lucario", hotness: "📈 Rising", notes: "Sep 16 launch wave — Lucario variant" },
  { id: "30th-tech-sticker-exeggutor", walmartItemId: 20742513584, imageUrl: "https://images.pokemontcg.io/sv3pt5/logo.png", name: "30th Celebration Tech Sticker Collection (Alolan Exeggutor)", set: "30th Celebration", type: "Premium Collection", msrp: 14.99, tcgplayerUrl: tcgUrl("30th Celebration Tech Sticker Collection"), ...retailLinks("Pokemon 30th Celebration Tech Sticker Collection Alolan Exeggutor"), ebayQuery: "Pokemon 30th Celebration Tech Sticker Collection Alolan Exeggutor", hotness: "📈 Rising", notes: "Sep 16 launch wave — Alolan Exeggutor variant; same Target TCIN 1010892078 covers both variants at Target, Walmart lists them as separate items" },
];
